...
{ Employdata[user.index].tasks.map((task,index)=>{
  if(task.active){
    return <div  key={task.title} className=" relative h-[90%] overflow-hidden w-[230px] lg:w-[300px] flex-shrink-0 border shadow-sm shadow-gray-300 text-white font-bold rounded-xl "><div className='flex flex-row absolute let-1  rounded-xl gap-1   bottom-1'>
